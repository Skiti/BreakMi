...
bleno.on('stateChange', function(state) {
	...
	if (state === 'poweredOn') {
		...
		function advertiseXiaomiTracker() {
			...
			ReqFirmwareService = require(devicePackage  + '/target-services/mitm/FirmwareService');
			...
			ReqHeartRateService = require(devicePackage  + '/target-services/mitm/HeartRateService');
			ReqHuamiFee0Service = require(devicePackage  + '/target-services/mitm/HuamiFee0Service');
			ReqHuamiFee1Service = require(devicePackage  + '/target-services/mitm/HuamiFee1Service');
		...
		function advertiseFitbitTracker() {
			ReqGenericAccessService = require(devicePackage  + '/services/GenericAccessService');
			ReqFitbitAdabfb00Service = require(devicePackage  + '/target-services/mitm/FitbitAdabfb00Service');
			ReqCommunicationService = require(devicePackage  + '/target-services/mitm/CommunicationService');
