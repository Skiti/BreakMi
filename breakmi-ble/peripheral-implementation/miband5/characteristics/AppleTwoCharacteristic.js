...
AppleTwoCharacteristic.prototype.onReadRequest = function(offset, callback) {
  console.log('AppleTwoCharacteristic - onReadRequest: value = ' + this._value.toString('hex'));
