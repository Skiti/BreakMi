...
bleno.on('stateChange', function(state) {
	...
	if (state === 'poweredOn') {
		...
		function advertiseXiaomiTracker() {
			...
			ReqFirmwareService = require(devicePackage  + '/target-services/impersonation-peripheral/FirmwareService');
			...
			ReqHeartRateService = require(devicePackage  + '/target-services/impersonation-peripheral/HeartRateService');
			ReqHuamiFee0Service = require(devicePackage  + '/target-services/impersonation-peripheral/HuamiFee0Service');
			ReqHuamiFee1Service = require(devicePackage  + '/target-services/impersonation-peripheral/HuamiFee1Service');
		...
		function advertiseFitbitTracker() {
			ReqGenericAccessService = require(devicePackage  + '/services/GenericAccessService');
			ReqFitbitAdabfb00Service = require(devicePackage  + '/target-services/impersonation-peripheral/FitbitAdabfb00Service');
			ReqCommunicationService = require(devicePackage  + '/target-services/impersonation-peripheral/CommunicationService');
