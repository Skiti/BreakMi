...
The folder [node_modules](https://github.com/Skiti/BreakMi/tree/main/breakmi-ble/node_modules) contains pre-downloaded node module that should make easier for the user to simply execute our code. Depending on your setup (i.e., Node.js version), you might see additional warnings/errors while executing BreakMi.